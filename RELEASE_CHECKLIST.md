# Release Checklist — arjundhi/magento2-email
...
- [ ] Verify `Rameera_Email` appears in `bin/magento module:status`
- [ ] Confirm email templates load in Admin → Marketing → Email Templates
- [ ] Test order email, account-change email, password-reset email
